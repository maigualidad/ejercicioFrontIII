...
/*
  ...
  update(pokemon) {
    ...
    this.setState({pokemon: this.pokemon.map(poke => this.pokemon)})
    console.log(pokemon);
  ...
  // Esta funcion lo que hace es preguntar si el id existe, lo convierte en string, y compara el tamaño, 
  // para saber si le agrega los 0 o no
  ...
  // Esta funcion optiene los tipos de pokemon. 
